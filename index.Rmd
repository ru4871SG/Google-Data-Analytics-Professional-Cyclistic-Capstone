...
The above data viz shows that both casuals and members like to use Cyclistic bikes between June and September, which are basically the summer months. It is understandable, considering bike services are typically more popular during summertime.
...
From the above data viz, you can see how both casuals and members like to use Cyclistic bikes between 15-18 (3 PM - 6 PM).
